...
name= classinfo["all"][5]["name"]
power= classinfo["all"][5]["super power"]

print(f'my name is {name} and my super power is {power}')
...
for i in classinfo["all"]:
    ...
    print(f'{name}, a {skill} {spirit} of a programmer, possesses a {power} factor for moonlighting as a super hero!')
